...
{{One striking, true number on screen: "Secondary-market prices in this category moved {{X}}% in {{period}} — here's what the data actually shows."}}

— SETUP (0:15–0:45) — why a single price misleads —
...
{{Un chiffre vrai et marquant à l'écran : « Le prix moyen dans cette catégorie a bougé de {{X}}% en {{période}} — voici ce que disent vraiment les données. »}}
...
{{"You don't need a headless browser to scrape {{site}}."  /  "{{Category}} just did something weird in the data."}}
...
{{« Pas besoin de navigateur headless pour scraper {{site}}. »  /  « Cette {{catégorie}} a fait un truc bizarre dans les données. »}}
