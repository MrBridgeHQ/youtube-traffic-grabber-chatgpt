...
YouTube hands you a wall of numbers, and most of them are vanity. This skill exists to drive **referral traffic and conversions to your assets** — so the measurement plan is built backwards from that, not from "more subscribers." The metrics sit in three layers, each answering a different question, in funnel order:
...
3. **Traffic & conversion** — *do they leave YouTube for the asset, and do they convert?* (clicks-to-site, tool sign-ups / leads attributable via your attribution param) — **the layer that matters most here**
...
> Reminder on what YouTube measurement *cannot* tell you: YouTube outbound links are **nofollow** — they pass referral traffic and brand exposure, **not** SEO equity. So there is no "link value" to measure here. Measure clicks, visits, conversions, and brand lift. Actual link-building belongs to a dedicated off-page method.
...
- **Conversions** — the business outcome on the destination: **tool sign-ups / runs / installs attributable via your attribution param**, site leads/sales, email opt-ins, lead-magnet downloads.
...
- **Affiliate attribution:** your **attribution/affiliate parameter** on every tracked link is how sign-ups/installs get attributed to this channel. No attribution param = the conversion happened but you can't prove it came from your video. (Stack UTM *and* your attribution param on tracked links — UTM for GA4, the affiliate param for platform-side attribution.)
...
- **Conversions happening but unattributed** → an attribution-param / UTM hygiene failure. Audit every link in the description, pinned comment, and end screen.
- **Tempted to inflate any of this** → don't. Bought/botted clicks and fake sign-ups are fraud-adjacent and a ToS violation; they also poison your own data so you can't tell what actually works.
...
For each video, the question is not "how many views" but: **Search-led discovery → strong retention → clicks-to-site → attributable conversions (attribution param / GA4).** Read Reach for layer 1, Engagement + the retention curve for layer 2, and GA4 + your attribution param for layer 3 — and fix the *first* layer that's weak before touching the others.
